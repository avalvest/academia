! function(e, t) {
    ...
    var t, a, r = e(),
        ...
        m = function(t) {
            ...
            t.attr("aria-dropeffect", "move"), n.attr("draggable", "true"), "function" == typeof document.createElement("span").dragDrop && n.on("mousedown.h5s", function() {
        ...
        x = function(i, d) {
            ...
            return d = e.extend({
                ...
                var s, g, c, p = i.children(d.items),
