...
if (typeof Tablesaw === "undefined") {
    Tablesaw = {
        i18n: {
            modes: ['Extendido', 'Tabla', 'Toggle'],
            columns: 'Col<span class=\"a11y-sm\">umn</span>as',
...
(function(win, $, undefined) {
    ...
    function createSwipeTable($table) {
        ...
        var $btns = $("<div class='tablesaw-advance'></div>"),
            $prevBtn = $("<a href='#' class='tablesaw-nav-btn btn btn-micro left tabulable' title='Previous Column'></a>").appendTo($btns),
            $nextBtn = $("<a href='#' class='tablesaw-nav-btn btn btn-micro right tabulable' title='Next Column'></a>").appendTo($btns),
            hideBtn = 'disabled',
